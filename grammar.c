...
*/
#ifdef YYTRACKMAXSTACKDEPTH
int CellAtomParseStackPeak(void *p){
  yyParser *pParser = (yyParser*)p;
...
static void yyStackOverflow(yyParser *yypParser, YYMINORTYPE *yypMinor){
   ...
   ** stack every overflows */
   CellAtomParseARG_STORE; /* Suppress warning about unused %extra_argument var */
}
...
#line 727 "grammar.c"
        break;
      case 1: /* statement_list ::= statement statement_list */
#line 39 "grammar.y"
{
	// This is really inefficient, but it's good enough for a toy parser.
	uintptr_t *l = (uintptr_t*)yymsp[0].minor.yy0;
	if (l == NULL)
	{
		l = calloc(sizeof(uintptr_t), 2);
		l[0] = 1;
		l[1] = (uintptr_t)yymsp[-1].minor.yy0;
		yygotominor.yy0 = (void*)l;
	}
	else
	{
		uintptr_t count = l[0];
...
#line 758 "grammar.c"
      ...
      case 4: /* expression ::= NUMBER */ yytestcase(yyruleno==4);
      case 5: /* expression ::= REGISTER */ yytestcase(yyruleno==5);
#line 66 "grammar.y"
{
...
#line 767 "grammar.c"
        break;
      case 6: /* expression ::= LSQ REGISTER BAR range_list */
#line 81 "grammar.y"
{
	struct RangeMap *rl = yymsp[0].minor.yy0;
	rl->value = (uintptr_t)yymsp[-2].minor.yy0;
	yygotominor.yy0 = allocNode(NTRangeMap, rl, 0);
}
#line 776 "grammar.c"
        break;
      case 7: /* range_list ::= ranges RSQ */
#line 88 "grammar.y"
{
...
#line 783 "grammar.c"
        break;
      case 8: /* range_list ::= ranges range RSQ */
      case 9: /* ranges ::= ranges range COMMA */ yytestcase(yyruleno==9);
#line 92 "grammar.y"
{
	yygotominor.yy0 = combineRanges(yymsp[-2].minor.yy0, yymsp[-1].minor.yy0);
}
#line 791 "grammar.c"
        break;
      case 11: /* range ::= LBR NUMBER COMMA NUMBER RBR EQ GT expression */
#line 103 "grammar.y"
{
	struct RangeMap *rm =
		calloc(1, sizeof(struct RangeMap) + sizeof(struct RangeMapEntry));
	rm->count = 1;
	rm->entries[0].min = (uintptr_t)yymsp[-6].minor.yy0;
	rm->entries[0].max = (uintptr_t)yymsp[-4].minor.yy0;
	rm->entries[0].val = (uintptr_t)yymsp[0].minor.yy0;
	yygotominor.yy0 = rm;
}
#line 804 "grammar.c"
        break;
      case 12: /* range ::= NUMBER EQ GT expression */
#line 113 "grammar.y"
{
	struct RangeMap *rm =
		calloc(1, sizeof(struct RangeMap) + sizeof(struct RangeMapEntry));
	rm->count = 1;
	rm->entries[0].min = (uintptr_t)yymsp[-3].minor.yy0;
	rm->entries[0].max = (uintptr_t)yymsp[-3].minor.yy0;
	rm->entries[0].val = (uintptr_t)yymsp[0].minor.yy0;
	yygotominor.yy0 = rm;
}
#line 817 "grammar.c"
        break;
      case 13: /* statement ::= PLUS REGISTER expression */
#line 126 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorAdd, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 824 "grammar.c"
        break;
      case 14: /* statement ::= SUB REGISTER expression */
#line 130 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorSub, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 831 "grammar.c"
        break;
      case 15: /* statement ::= MUL REGISTER expression */
#line 134 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorMul, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 838 "grammar.c"
        break;
      case 16: /* statement ::= DIV REGISTER expression */
#line 138 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorDiv, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 845 "grammar.c"
        break;
      case 17: /* statement ::= MIN REGISTER expression */
#line 142 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorMin, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 852 "grammar.c"
        break;
      case 18: /* statement ::= MAX REGISTER expression */
#line 146 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorMax, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 859 "grammar.c"
        break;
      case 19: /* statement ::= EQ REGISTER expression */
#line 150 "grammar.y"
{
	yygotominor.yy0 = allocNode(NTOperatorAssign, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
}
#line 866 "grammar.c"
        break;
      case 20: /* statement ::= NEIGHBOURS LBR statement_list RBR */
#line 154 "grammar.y"
{
	uintptr_t *l = (uintptr_t*)yymsp[-1].minor.yy0;
	uintptr_t count = l[0];
	memmove(l, l+1, count * sizeof(uintptr_t));
	yygotominor.yy0 = allocNode(NTNeighbours, (void*)count, l);
}
#line 876 "grammar.c"
        break;
      default:
      /* (10) ranges ::= */ yytestcase(yyruleno==10);
        break;
  };
...
static void yy_parse_failed(
  ...
  ** parser fails */
  CellAtomParseARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
...
** "CellAtomParseAlloc" which describes the current state of the parser.
...
void CellAtomParse(
  ...
  CellAtomParseTOKENTYPE yyminor       /* The value for the token */
  CellAtomParseARG_PDECL               /* Optional %extra_argument parameter */
){
